...
const MenuSection = ({ addToCart }: MenuSectionProps) => {
  return (
    <section className=" px-4 mt-[-40px] sm:mt-10 container mx-auto mb-10 max-w-7xl bg-gradient-to-b from-yellow-50 to-white py-10 rounded-xl shadow-lg">
